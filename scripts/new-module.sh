...
for file in doc.go README.md CONTRACTS.md contract.go models.go events.go queries.go repository.go service.go; do
...
echo "  3. Implement models.go, queries.go, repository.go, and service.go"
