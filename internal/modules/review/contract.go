...
//
// MODULE-SPECIFIC RULES (review only):
//   - Terminal verdicts (approved, changes_requested, needs_discussion) are immutable.
//   - One review per gate per work unit is enforced at the service layer.
//   - NEVER call task.Service or run.Service methods directly.
//
