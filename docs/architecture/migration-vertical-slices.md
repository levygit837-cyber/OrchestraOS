...
1. `internal/core/orchestration/` - Helpers cross-domain (TransitionInput, OperationResult, RuntimeEventRelay)
...
- Testes de integração podem focar em interações via core/orchestration
