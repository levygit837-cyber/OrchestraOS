...
No M0, os contratos executaveis devem cobrir apenas o nucleo necessario para criar uma task local, registrar eventos e conectar uma run a uma work unit executada por agente:
